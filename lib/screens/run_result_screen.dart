              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    if (isRecord)
                      Text('NEW RECORD!', style: NeonTextStyles.title(size: 28, color: NeonColors.gold))
                    else
                      Text('RUN COMPLETE', style: NeonTextStyles.heading(size: 22)),
                    const SizedBox(height: 6),
                    Text(
                      'Survived ${summary.formattedTime}  •  ${summary.phaseReached.label}',
                      style: NeonTextStyles.body.copyWith(color: Colors.white70),
                    ),
                    const SizedBox(height: 24),
                    Container(
                      padding: const EdgeInsets.all(20),
                      decoration: NeonColors.neonPanel(color: NeonColors.cyan, opacity: 0.4),
                      child: Column(
                        children: [
                          _RewardRow(
                            leading: const PickupIcon(kind: SlotKind.energy, size: 22),
                            label: 'Neon Energy',
                          ...
                          const SizedBox(height: 14),
                          _RewardRow(
                            leading: const PickupIcon(kind: SlotKind.shard, size: 22),
                          ...
                          _RewardRow(
                            leading: const Icon(Icons.meeting_room_rounded,
                                color: NeonColors.violet, size: 24),
                            label: 'Gates Flown',
                    ...
                    if (dailyChallengeJustCompleted) ...[
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: NeonColors.gold.withValues(alpha: 0.5)),
                        ),
                        child: Row(
                          children: [
                            const Icon(Icons.today_rounded, color: NeonColors.gold),
